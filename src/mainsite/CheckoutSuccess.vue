...
.page-shell {
  max-width: 760px;
  margin: 0 auto;
  padding: 20px 16px calc(32px + var(--app-safe-area-bottom, env(safe-area-inset-bottom, 0px)));
}
...
@media (min-width: 768px) {
  .page-shell {
    padding: 28px 24px calc(40px + var(--app-safe-area-bottom, env(safe-area-inset-bottom, 0px)));
  }
